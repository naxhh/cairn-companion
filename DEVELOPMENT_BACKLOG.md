...
- I'm unsure on the diff of hireling and npc when it comes to the plugin... not sure what to do with it
...
## Done
- Review License shenanigans
- Tweak DEVELOPMENT.md
- Tweak README.md
- Review build tooling
- Separate code in modules
- i18n for EN plugin
- i18n move entries to /data (scars, dungeonEventsTable, wildernessEventsTable)
- Add EN data
- Review code
